...
import { beginnerContent } from '@/data/beginnerContent';
import { quickReferences } from '@/data/quickReferences';

export default function BeginnerPage() {
  const beginnerReferences = quickReferences.filter((ref) => ref.level === 'beginner');
    ...
    <div className="container py-12">
      ...
      <div className="mb-12 text-center">
        <div className="mb-6 flex justify-center">
          <img
            src="/assets/generated/beginner-icon.dim_128x128.png"
            alt="Beginner level"
            className="h-32 w-32"
          />
        </div>
        <h1 className="mb-4 text-4xl font-bold tracking-tight md:text-5xl">Beginner Level</h1>
        <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
          Welcome to your stock market journey! This section covers all the fundamentals you need to understand stocks,
          markets, and basic investing principles. No prior knowledge required.
        </p>
      </div>
      ...
      <section className="mt-16">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {beginnerReferences.map((reference) => (
            <QuickReferenceCard
              key={reference.id}
